...
const TRANSLATIONS = {
  en: {
    ...
    leads: {
      ...
      convertConfirm: 'Convert this lead into a project? The lead will be marked as won.',
      convertSuccess: 'Lead successfully converted to project.',
      convertedFrom: 'Converted from lead',
      visibility: 'Visibility',
      visibilityPublic: 'Public (all users)',
      visibilityRestricted: 'Restricted (selected groups only)',
      groups: 'Access Groups',
      groupsHint: 'Only members of the selected groups can see this lead.',
      noGroups: 'No groups assigned. All users with lead access can see this.',
    },
    notes: {
  ...
  de: {
    ...
    leads: {
      ...
      convertConfirm: 'Diesen Lead in ein Projekt umwandeln? Der Lead wird als gewonnen markiert.',
      convertSuccess: 'Lead erfolgreich in Projekt umgewandelt.',
      convertedFrom: 'Aus Lead konvertiert',
      visibility: 'Sichtbarkeit',
      visibilityPublic: 'Öffentlich (alle Benutzer)',
      visibilityRestricted: 'Eingeschränkt (nur ausgewählte Gruppen)',
      groups: 'Zugriffsgruppen',
  ...
  cs: {
    ...
    leads: {
      ...
      convertConfirm: 'Převést tento lead na projekt? Lead bude označen jako vyhraný.',
      convertSuccess: 'Lead byl úspěšně převeden na projekt.',
      convertedFrom: 'Převedeno z leadu',
      visibility: 'Viditelnost',
      visibilityPublic: 'Veřejný (všichni uživatelé)',
      visibilityRestricted: 'Omezený (pouze vybrané skupiny)',
      groups: 'Přístupové skupiny',
      groupsHint: 'Tento lead vidí pouze členové vybraných skupin.',
      noGroups: 'Žádné skupiny přiřazeny. Všichni uživatelé s přístupem k leadům ho vidí.',
    },
    notes: {
