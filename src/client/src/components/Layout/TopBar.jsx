...
import GlobalSearchDialog from '../common/GlobalSearchDialog.jsx';
    ...
    <>
      ...
      >
        <Toolbar>
          ...
          <Tooltip title={t('search.globalSearch', 'Search')}>
            <IconButton onClick={() => setSearchOpen(true)} sx={{ mr: 1 }} aria-label={t('search.globalSearch', 'Search')}>
              <SearchIcon />
            </IconButton>
          </Tooltip>
